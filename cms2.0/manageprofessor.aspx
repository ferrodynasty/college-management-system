<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manageprofessor.aspx.cs" Inherits="cms2._0.manageprofessor" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Manage Professors – CMS 2.0</title>
...
<div class="container">
    <div class="header">
        <div>
            <h2 style="margin:0">Manage Professors</h2>
        ...
        <div>
            ...
            <asp:Button ID="btnToggle" runat="server" CssClass="btn" Text="+ Add Professor"
    ...
    <asp:Panel ID="pnlAdd" runat="server" CssClass="form-panel" Visible="false" style="margin-bottom:16px;">
        <h4 style="margin:0 0 8px">Add Professor</h4>
        <label>Professor ID</label>
        <asp:TextBox ID="txtId"    runat="server" placeholder="e.g. P003" /><br />
        ...
        <asp:TextBox ID="txtDept"  runat="server" placeholder="e.g. Computer Science" /><br />
    ...
    <div class="card-grid">
        <asp:Repeater ID="rptProfs" runat="server" OnItemCommand="rptProfs_ItemCommand">
            <ItemTemplate>
                <div class="mini-card">
                    <div class="name"><%# Eval("prof_id") %> — <%# Eval("full_name") %></div>
                    <div class="meta"><%# Eval("dept") %> &bull; <%# Eval("email") %></div>
                    <asp:LinkButton CommandName="Delete" CommandArgument='<%# Eval("prof_id") %>'
                        runat="server" style="font-size:12px;color:#c0392b;margin-top:6px;display:inline-block;"
                        OnClientClick="return confirm('Delete this professor?');">Delete</asp:LinkButton>
                </div>
            </ItemTemplate>
        </asp:Repeater>
    </div>
