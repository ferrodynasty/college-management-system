<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentDesk.aspx.cs" Inherits="cms2._0.studentDesk" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Student Desk – CMS 2.0</title>
...
<form id="form1" runat="server">
    ...
    <div class="id-card">
        ...
        <div class="card-body">
            ...
            <ul>
                ...
                <li><strong>Class:</strong>   <asp:Literal ID="litClass"   runat="server" /></li>
    ...
    <div class="admin-actions" style="margin-top:18px;">
        <a class="btn-link" href="marks.aspx">See Marks</a>
        <a class="btn-link" href="attendance.aspx">See Attendance</a>
        <a class="btn-link" href="homework.aspx">See Homework</a>
        <a class="btn-link" href="doubt.aspx">Ask a Doubt</a>
    </div>
</form>
</body>
</html>
